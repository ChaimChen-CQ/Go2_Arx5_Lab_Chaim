...
class Go2ARMFlatEnvCfg(LocomotionVelocityEnvCfg):
    def __post_init__(self):
        ...
        self.actions.arm_pose.scale["joint2"] = 0.65
        self.actions.arm_pose.scale["joint3"] = 0.65
        self.actions.arm_pose.scale["joint4"] = 0.55
        ...
        # position command 
        self.commands.ee_pose.curriculum_coeff = 2500
        # init
        self.commands.ee_pose.ranges_init.pos_x = (0.55, 0.62)
        self.commands.ee_pose.ranges_init.pos_y = (-0.04, 0.04)
        self.commands.ee_pose.ranges_init.pos_z = (0.38, 0.48)
        # final
        self.commands.ee_pose.ranges_final.pos_x = (0.55, 0.72)
        self.commands.ee_pose.ranges_final.pos_y = (-0.25, 0.25)
        self.commands.ee_pose.ranges_final.pos_z = (0.18, 0.58)

        # reward weight
        # arm
        self.rewards.end_effector_position_tracking.weight = 5.0
        self.rewards.end_effector_position_tracking.params["std"] = 0.15
        self.rewards.end_effector_forward_tracking.weight = 2.0
        self.rewards.end_effector_forward_tracking.params["std"] = 0.06
        self.rewards.end_effector_orientation_tracking.weight = -0.5
        self.rewards.end_effector_action_rate.weight = -0.003 #-0.005 
        self.rewards.end_effector_action_smoothness.weight = -0.01 #-0.02
        ...
        self.rewards.F_feet_air_time.weight = 0.55 #0.5
        self.rewards.R_feet_air_time.weight = 0.55 #0.5
        self.rewards.F_feet_air_time.params["threshold"] = 0.25
        self.rewards.R_feet_air_time.params["threshold"] = 0.25

        self.rewards.feet_height.weight = -0.35 #TODO
        self.rewards.feet_height.params["target_height"] = 0.08
        self.rewards.feet_height_body.weight = -0.8 #TODO
        self.rewards.feet_height_body.params["target_height"] = -0.23
        self.rewards.foot_contact.weight = 0.003 #0.003
        self.rewards.hip_deviation.weight = -0.08
        self.rewards.joint_deviation.weight = -0.004
        self.rewards.action_smoothness.weight = -0.008
...
class Go2ARMFlatEnvCfg_PLAY(Go2ARMFlatEnvCfg):
    def __post_init__(self) -> None:
        ...
        self.commands.ee_pose.ranges.pos_x = (0.58, 0.72)
        self.commands.ee_pose.ranges.pos_y = (-0.20, 0.20)
        self.commands.ee_pose.ranges.pos_z = (0.22, 0.52)
